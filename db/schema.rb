...
ActiveRecord::Schema[7.1].define(version: 2025_07_01_162334) do
  ...
  create_table "agent_conversations", force: :cascade do |t|
    t.bigint "helpforce_agent_id", null: false
    ...
    t.index ["ai_provider"], name: "index_agent_conversations_on_ai_provider"
    t.index ["conversation_id", "created_at"], name: "index_agent_conversations_on_conversation_id_and_created_at"
    t.index ["conversation_id"], name: "index_agent_conversations_on_conversation_id"
    t.index ["helpforce_agent_id", "created_at"], name: "index_agent_conversations_on_helpforce_agent_id_and_created_at"
    t.index ["helpforce_agent_id"], name: "index_agent_conversations_on_helpforce_agent_id"
    t.index ["response_time"], name: "index_agent_conversations_on_response_time"
  end
  ...
  create_table "agent_metrics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["helpforce_agent_id", "metric_type", "metric_date"], name: "index_agent_metrics_on_agent_type_date"
    t.index ["helpforce_agent_id", "recorded_at"], name: "index_agent_metrics_on_helpforce_agent_id_and_recorded_at"
    t.index ["helpforce_agent_id"], name: "index_agent_metrics_on_helpforce_agent_id"
    t.index ["metric_type"], name: "index_agent_metrics_on_metric_type"
  end
  ...
  create_table "conversation_agent_assignments", force: :cascade do |t|
    t.bigint "conversation_id", null: false
    t.bigint "helpforce_agent_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["auto_assigned"], name: "index_conversation_agent_assignments_on_auto_assigned"
    t.index ["confidence_score"], name: "index_conversation_agent_assignments_on_confidence_score"
    t.index ["conversation_id", "active"], name: "idx_on_conversation_id_active_3e513758fe"
    t.index ["conversation_id"], name: "index_conversation_agent_assignments_on_conversation_id"
    t.index ["helpforce_agent_id", "assigned_at"], name: "idx_on_helpforce_agent_id_assigned_at_36635535bc"
    t.index ["helpforce_agent_id"], name: "index_conversation_agent_assignments_on_helpforce_agent_id"
  end
  ...
  create_table "helpforce_agents", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "user_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "agent_id"], name: "index_helpforce_agents_on_account_id_and_agent_id", unique: true
    t.index ["account_id", "category"], name: "index_helpforce_agents_on_account_id_and_category"
    t.index ["account_id", "status"], name: "index_helpforce_agents_on_account_id_and_status"
    t.index ["account_id"], name: "index_helpforce_agents_on_account_id"
    t.index ["ai_provider"], name: "index_helpforce_agents_on_ai_provider"
    t.index ["user_id"], name: "index_helpforce_agents_on_user_id"
  end
  ...
  add_foreign_key "agent_conversations", "conversations"
  add_foreign_key "agent_conversations", "helpforce_agents"
  add_foreign_key "agent_metrics", "helpforce_agents"
  add_foreign_key "conversation_agent_assignments", "conversations"
  add_foreign_key "conversation_agent_assignments", "helpforce_agents"
  add_foreign_key "helpforce_agents", "accounts"
  add_foreign_key "helpforce_agents", "users"
