...
if Rails.env.production?
  ...
  Redis::Alfred.set(Redis::Alfred::WORQCHAT_INSTALLATION_ONBOARDING, true)
end
...
unless Rails.env.production?
  ...
  CannedResponse.create!(account: account, short_code: 'start', content: 'Hello welcome to WorqChat.')
end
