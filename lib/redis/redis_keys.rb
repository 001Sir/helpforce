module Redis::RedisKeys
  ...
  WORQCHAT_INSTALLATION_ONBOARDING = 'WORQCHAT_INSTALLATION_ONBOARDING'.freeze
  WORQCHAT_INSTALLATION_CONFIG_RESET_WARNING = 'WORQCHAT_CONFIG_RESET_WARNING'.freeze
  LATEST_WORQCHAT_VERSION = 'LATEST_WORQCHAT_VERSION'.freeze
