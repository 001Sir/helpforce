export default {
  ...
  DOCS_URL: 'https://docs.worqchat.com/product/',
  HELP_CENTER_DOCS_URL:
    'https://docs.worqchat.com/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.worqchat.com/content.json',
