class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_worqchat_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_WORQCHAT_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless WorqChatCaptcha.new(params[:h_captcha_client_response]).valid?
  end
